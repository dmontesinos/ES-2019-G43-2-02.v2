...
\newcommand{\NomDocument}{Procedimientos de pruebas}
\newcommand{\IdentificadorDocument}{GG-SL-N-TP}
\newcommand{\VersioDocument}{v1.0}
...
\begin{center}
	...
	\hline
	\cellcolor[gray]{.8} \textbf{Step} & \cellcolor[gray]{.9} #1\\
	\hline
	\cellcolor[gray]{.8} \textbf{Description} & #2 \\
	\hline
	\cellcolor[gray]{.8} \textbf{Input} & #3\\
	\hline
	\cellcolor[gray]{.8} \textbf{Output} & #4 \\
	\hline
	\cellcolor[gray]{.8} \textbf{Comments} & #5 \\
	\hline
	\end{tabularx}
\end{center}
}
...
\hline
\multicolumn{4}{|>{\columncolor[gray]{.9}[2mm][2mm]}c|}{{\bf Abreviaturas}} \\
\hline
...
\hline
\multicolumn{4}{|>{\columncolor[gray]{.9}[2mm][2mm]}c|}{{\bf Historial de Revisiones}} \\
\hline
{\bf Version} & {\bf Date} & {\bf Comments} & {\bf Autor} \\
\hline
1.0 & 27-Mayo-2019 & Sprint 4 &
G43-2-02 \\
\hline
\end{tabular}
\end{center}
