...
\begin{center}
	\begin{figure}
		\centering
			\subfloat{
			\includegraphics[width=0.5\textwidth]{./imatges/S1.png}}
			\subfloat{
			\includegraphics[width=0.5\textwidth]{./imatges/S2.png}}
	\end{figure}
\end{center}
}
...
\begin{center}
	\begin{figure}
		\centering
			\subfloat{
			\includegraphics[width=0.5\textwidth]{./imatges/S3.png}}
			\subfloat{
			\includegraphics[width=0.5\textwidth]{./imatges/S4.png}}
	\end{figure}
\end{center}
}
